...
class FormPreview extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  constructor(props) {
    ...
    let loadData = (this.props.url) ? this.props.url : (this.props.data) ? this.props.data : [];
    let saveUrl = (this.props.saveUrl) ? this.props.saveUrl : '';
...
FormPreview.defaultProps = { showCorrectColumn: false, files: [], editMode: false, editElement: null, className: 'react-form-builder-preview pull-left'}
