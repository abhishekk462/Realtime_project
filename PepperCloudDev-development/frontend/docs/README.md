...
1. First, let's install the dependencies and start the local development server:
...
1. Open [localhost:3000](http://localhost:3000) to see it in action.
    ...
    - Lead list to see the list page
    - New Lead Page to add new Lead entry
...
1. Time to build your own app: run
    ...
    ...and also can use the built-in generators to add new features.
...
*(If they do have to be changed, please [submit an issue](http://netcadre.com:8080/)!)*
