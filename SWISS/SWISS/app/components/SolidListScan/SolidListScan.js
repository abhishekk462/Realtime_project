...
import styles from  './SolidListscan.css';
import MenuBar from "../MenuBar/Menubar";
import FooterBar from "../FooterBar";
import TitleBar from "../TitleBar";
import Box5 from '../SolidListScan/SolidScanDelete'
...
export default class SolidScan extends Component {
  constructor( props ){
    super( props )
...
toggleDiv3(){
  ...
  handleClick = () => {
    ...
    <div>
   <p id={styles.txt1}> Shimamura_342354238.xlx</p>
   </div>
    </Grid.Column>
...
{ this.state.show && <Box1 /> }
  ...
  <Segment>
    <div>
<h4 id={styles.h4}>SCANNED LIST</h4><span>
  <Icon onClick={ this.toggleDiv2 } id={styles.opendiv}  name='angle up' /></span>
</div><br />

<br />
{ this.state.show2 && <Box5/> }


  </Segment>
  <Segment>
    <div>
<h4 id={styles.h4}>SAVED LIST</h4><span><Icon onClick={ this.toggleDiv2 } id={styles.opendiv}  name='angle up' /></span>
</div><br />
...
<Grid.Column  tablet={2} computer={2}>
    ...
    <Button className={`ui circular button ${styles.swiss_NEXT}`} >Load</Button>
